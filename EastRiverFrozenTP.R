...
load("M:/NonPoint Evaluation/GLRI Edge-of-field/JessicaStuff/GLRI/dataSubEastRiverFrozen.RData")
...
#################################################################################################
#Kitchen sink:
predictVariables <- names(data_sub_cens2)[-which(names(data_sub_cens2) %in% investigateResponse)]
