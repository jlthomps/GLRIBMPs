...
load("M:/NonPoint Evaluation/GLRI Edge-of-field/JessicaStuff/GLRI/dataSubEastRiverSplit.RData")
...
#################################################################################################
#Kitchen sink:
predictVariables <- names(data_sub_cens2)[-which(names(data_sub_cens) %in% investigateResponse)]
...
returnPrelim <- prelimModelDev(data_sub_cens2,investigateResponse,kitchenSink,
...
source("M:/NonPoint Evaluation/GLRI Edge-of-field/JessicaStuff/GLRI/plotStepsGLRI.R")
